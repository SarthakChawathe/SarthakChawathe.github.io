...
//             MLE + Data Analyst
//         </h3>
//         <h1 className="full-name">Sarthak <span className="primary">Chawathe.</span>
//                 <br />
//                 I'm a <span className="primary typed" data-typed-items="Data Enthusiast., Machine Learning Engineer., Developer., Hodophile., Photographer., Home Chef."></span>
//             </h1>

//         <p className="home__description">
//             Problem solver with analytical and great communication skills. Desirous of a Data Scientist position, to leverage on solid Computer Science and Artificial Intelligence background. Coming with a solid mathematics foundation, programming skills, and the ability to clearly communicate complex and technical information.
//         </p>
...
const Data = () => {
  useEffect(() => {
    ...
    // //   cursorChar: '|', // Use a single pipe as the cursor
    // });
    new Typed('.typed', {
        strings: typedStrings,
        typeSpeed: 0, // Instant display of the word
        backSpeed: 0, // Instant erasing of the word
        backDelay: 1000, // Delay before backspacing
        startDelay: 500, // Initial delay before starting the typing effect
        loop: true,
        showCursor: false, // Disable the blinking cursor
        fadeOut: true, // Enable fade out effect
        fadeOutClass: 'typed-fade-out', // Class for fade out effect
        fadeOutDelay: 1000, // Delay before fade out effect starts
      });
    }, []);

  return (
    <div className="home__data">
      <h1 className="home__title">Sarthak Chawathe</h1>
      <h1 className="full-name">
        I'm a{' '}
        <span
          className="primary typed"
          data-typed-items="Data Enthusiast., Machine Learning Engineer., Developer., Hodophile., Photographer., Home Chef."
        >
        </span>
      </h1>
      <br />
      {/* <h3 className="home__subtitle">MLE + Data Analyst</h3> */}
      <p className="home__description">
        Problem solver with analytical and great communication skills. Desirous of a Data Scientist position, to leverage on solid Computer Science and Artificial Intelligence background. Coming with a solid mathematics foundation, programming skills, and the ability to clearly communicate complex and technical information.
      </p>
