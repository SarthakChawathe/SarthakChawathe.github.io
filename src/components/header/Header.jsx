    ...
    return(
        <header className="header">
            <nav className="nav container">
                <a href="index.html" className="nav__logo">Sarthak Chawathe</a>
                    ...
                    <ul className="nav__list grid">
                        ...
                        <li className="nav__item">
                            ...
                            className={activeNav === "#services" ? "nav__link active-link" : "nav__link"}>
                                <HiOutlineClipboardList className="nav__icon"/>Achievements
                            </a>
                        </li>
                        ...
                        <li className="nav__item">
                            ...
                            className={activeNav === "#testimonials" ? "nav__link active-link" : "nav__link"}>
                                <HiOutlineClipboardList className="nav__icon"/>Testimonials
                            </a>
                        </li>
